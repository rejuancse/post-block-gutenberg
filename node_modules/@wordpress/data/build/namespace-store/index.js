...
function createNamespace(key, options, registry) {
  ...
  var resolvers;
  var actions = mapActions((0, _objectSpread2.default)({}, metadataActions, options.actions), store);
  var selectors = mapSelectors((0, _objectSpread2.default)({}, (0, _lodash.mapValues)(metadataSelectors, function (selector) {
